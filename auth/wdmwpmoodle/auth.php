...
class auth_plugin_wdmwpmoodle extends auth_plugin_base
{
    ...
    public static function wdm_get_encrypted_query_args($args, $key)
    {
        ...
        $crypttext = mcrypt_encrypt(MCRYPT_RIJNDAEL_256, md5($key.$key), $query, MCRYPT_MODE_ECB, $iv);
    ...
    //     // save settings
    //     set_config('sharedsecret', $sharedsecret, 'auth/wdmwpmoodle');
    //     set_config('logoutredirecturl', $logoutredirecturl, 'auth/wdmwpmoodle');
    //     set_config('wpsiteurl', $wpsiteurl, 'auth/wdmwpmoodle');
