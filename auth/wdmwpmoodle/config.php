...
<tr valign="top" class="required">
    ...
    <td>
        <i><?php print_string('auth_wdmwpmoodle_wpsiteurl_desc', 'auth_wdmwpmoodle') ?></i>
            <?php
            if (!function_exists('mcrypt_encrypt')) {
                ob_start();
                ?>
                <p><b style="color: red"><?php print_string('auth_wdmwpmoodle_war_warning', 'auth_wdmwpmoodle') ?>: </b><a href="http://php.net/manual/en/book.mcrypt.php" target="_blank"><?php print_string('auth_wdmwpmoodle_war_mcrypt', 'auth_wdmwpmoodle') ?></a> <?php print_string('auth_wdmwpmoodle_war_desc', 'auth_wdmwpmoodle') ?></p>
                <?php
                echo ob_get_clean();
            }
            ?>
