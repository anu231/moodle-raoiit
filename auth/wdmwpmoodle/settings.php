...
if ($ADMIN->fulltree) {
    ...
    /*
     * Check is mcrypt extension is installed or not if not then display the warning message
     * otherwiser display simple extensions.
     */
    if (!function_exists('mcrypt_encrypt')) {
        $settings->add(
            new admin_setting_configtext(
                ...
                get_string('auth_wdmwpmoodle_wpsiteurl_desc_with_warning', 'auth_wdmwpmoodle'),
                '',
                PARAM_RAW
            )
        );
