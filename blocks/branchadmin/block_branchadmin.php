...
class block_branchadmin extends block_list {
   ...
   public function init(){
	...
	public function get_content(){
        ...
        $student_attendance = new moodle_url('/blocks/branchadmin/attendance.php', array('blockid' => $this->instance->id));
        ...
        $this->content->items[2] = html_writer::link($student_attendance,"Student Attendance");
        return $this->content;
    }
