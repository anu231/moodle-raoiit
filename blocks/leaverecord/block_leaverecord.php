...
class block_leaverecord extends block_list {
    ...
    public function get_content() {
        ...
        $this->content->items[1] = html_writer::link($view_leaves_form,"View Leaves");
        $this->content->items[2] = html_writer::link($attendance_master,"Attendance Master");
        //$this->content->items[3] = html_writer::link($faculty_register,"Faculty Register");
        //$this->content->items[4] = html_writer::link($faculty_timetable,"Faculty Timetable");
        return $this->content;
    } 
}
?>
