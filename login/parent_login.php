...
if (isloggedin() and !isguestuser()) {
    ...
    require_once('rao_form.php');
    $loginform = new parent_login_form();
    if ($data = $loginform->get_data()){
        //send otp to the number specified
        global $CFG;
        require_once($CFG->dirroot.'/auth/otp/classes/otputil.php');
        $otp_auth = new auth_otp_otputil();
        $otp_auth->send_parent_login_otp($data->username, $data->mobile);
        $SESSION->otp_username = $data->username;
        //redirect to accept otp page
