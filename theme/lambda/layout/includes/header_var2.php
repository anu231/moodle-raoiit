		...
		<div id="block-login" style="padding: 0;text-align: inherit;">
			...
			<input id="inputName" class="span2" type="text" name="username" placeholder="<?php echo $username; ?>" style="width: 100%;display: block;margin-bottom: 5px;">
				...
				<div class="forgotpass" style="line-height:18px">
					<?php 
					if ($login_link_url != '' and $login_link_txt != '') { ?>
					<a target="_self" href="<?php echo $login_link_url; ?>"><?php echo 'Create Demo Account';/*$login_link_txt;*/ ?></a>
					<?php } ?><br>
					<a target="_self" href="/login/parent_login.php">Parent Login</a><br>
					<a target="_self" href="<?php echo $wwwroot.'/login/forgot_password.php' ?>"><?php echo get_string('forgotten'); ?></a>
				</div>
